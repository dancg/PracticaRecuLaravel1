    ...
    <form name="as" method="POST" action="{{ route('peliculas.store') }}">
        ...
        <div class="mb-6">
            ...
            <textarea id="sinopsis" name="sinopsis" placeholder="Sinopsis..."
                ...
                dark:focus:ring-blue-500 dark:focus:border-blue-500">{{@old('sinopsis')}}</textarea>
                @error('sinopsis')
                <p class="text-red-700 text-xs italic mt-2">*{{$message}}</p>
                @enderror
        </div>
        ...
        <div class="mb-6">
            <label for="duracion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Duracion de la Película (en horas):</label>
        ...
        <div class="mb-6">            
            ...
            <select id="categorias" name="category_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="flex flex-row-reverse">
            ...
            focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 
